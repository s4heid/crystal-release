...
$ bosh vendor-package crystal-0.30.0 ~/workspace/crystal-release
```
...
```bash
source /var/vcap/packages/crystal-0.30.0/bosh/compile.env
crystal build ...
```
...
```bash
source /var/vcap/packages/crystal-0.30.0/bosh/runtime.env
crystal run ...
```
